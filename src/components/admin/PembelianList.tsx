          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              <tr className="hover:bg-slate-50">
                <td className="p-4 font-medium text-slate-900">Sepeda Gunung MTB</td>
                <td className="p-4 text-slate-600">Toko Sepeda Jaya</td>
                <td className="p-4 text-slate-600">2 unit</td>
                <td className="p-4 text-blue-700 font-bold">Rp3.500.000</td>
                <td className="p-4 text-slate-500">28/07/2026</td>
                <td className="p-4">
                  <span className="px-2 py-1 rounded-lg bg-blue-100 text-blue-700 text-xs font-bold">Cash</span>
                </td>
              </tr>
            </tbody>
          </table>
