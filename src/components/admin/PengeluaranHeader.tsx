...
export const PengeluaranHeader: React.FC = () => {
  return (
    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
      <div>
        ...
        <h1 className="text-2xl sm:text-3xl font-black text-slate-900">Pengeluaran</h1>
        <p className="text-xs text-slate-600 font-medium mt-0.5">
          Ringkasan real-time pengeluaran biaya operasional.
        </p>
      </div>
    </div>
  );
