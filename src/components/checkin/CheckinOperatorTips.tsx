...
export const CheckinOperatorTips: React.FC = () => {
  return (
    <div className="p-4 rounded-2xl bg-white border-2 border-[#E70013] text-xs text-[#E70013] space-y-2 font-bold shadow-sm">
      <span className="font-black flex items-center gap-1.5">
        <ShieldCheck className="w-4 h-4 text-[#E70013]" />
        Panduan Operasional Panitia:
      </span>
      <ul className="list-disc list-inside space-y-1 text-[11px] font-bold leading-relaxed">
