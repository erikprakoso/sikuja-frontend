  ...
  return (
    <div className="space-y-3">
      ...
      {sortedWinners.length === 0 ? (
        <div className="p-4 rounded-2xl bg-zinc-900 border-2 border-dashed border-zinc-600 text-center">
          <p className="text-xs font-bold text-zinc-400">
            Belum ada pemenang. Undi hadiah untuk menambahkan di sini.
          </p>
        </div>
      ) : (
        <div className="flex flex-col gap-1.5 max-h-[45vh] sm:max-h-[50vh] lg:max-h-[calc(100vh-8rem)] overflow-y-auto overscroll-contain pr-1 pb-2 [scrollbar-width:thin] [scrollbar-color:#facc15_transparent]">
          ...
          {hasMore && (
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 mt-1 py-2 rounded-xl bg-zinc-800 border border-zinc-600 text-yellow-400 text-[11px] font-black hover:bg-zinc-700 transition-colors cursor-pointer active:scale-95"
            >
