...
export const UndianHeader: React.FC<UndianHeaderProps> = ({
  ...
  return (
    <div className="flex items-center justify-end gap-6 pb-4 border-b border-slate-200">
      ...
      <button
        ...
        className="p-2.5 rounded-lg text-slate-500 hover:text-[#E70013] hover:bg-[#E70013]/5 transition-colors cursor-pointer"
