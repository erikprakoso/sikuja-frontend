...
-- 3. Donasi barang (in-kind): barang doorprize yang langsung diberikan donatur.
--    Tambah kolom donor_name di tabel purchases.
ALTER TABLE public.purchases
  ADD COLUMN IF NOT EXISTS donor_name TEXT;

-- 4. RPC upsert_purchase versi baru: dukung sumber dana 'donasi_barang'
--    (tanpa cek saldo kas) + simpan donor_name.
